...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative flex flex-col w-full justify-center items-center bg-[url("assets/gradientBackground.png")] bg-cover bg-no-repeat bg-center min-h-screen'>
  ...
  AI Tools
      ...
      <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
        <img src={assets} alt="Users group" className='h-8' />
